					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 class="blue" id="id-company-text">&copy; Avalon</h4>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form id="dologin" action="${hosts}/login.do" method="post">
												<fieldset>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
			 ...
			 $("#dologin").submit(function(){
				 var jsonData = $("#dologin").serializeArray();
				 $.ajax({
			             type: "POST",
			             url: "${hosts}/dologin.do",
			             data: jsonData,
			             dataType: "json",
			             success: function(data){
			               if(data.success){
			            	   ...
			            	   var id="#userName";
			            	   var index=1;
			            	   if(data.data==2){id="#password";index=3;};
