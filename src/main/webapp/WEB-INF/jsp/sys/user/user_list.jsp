			...
			jQuery(function($) {
					...
					aoColumns: [
					  { "title": '<label class="pos-rel"><input type="checkbox" class="ace" /><span class="lbl"></span></label>',
					    "mDataProp" : function(source,type,val){
							return '<label class="pos-rel"><input type="checkbox" class="ace" value="'+source.uid+'" /><span class="lbl"></span></label>'},
					    "defaultContent": '',
					    "sType":"html",
					    "bSortable": false,
						"bVisible": true
				...
				$('#table-add').on('click',function(){
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '400px'],
					  content: '${hosts}/jump.do?jsp=/sys/user/user_add' //iframe的url
					}); 
				...
				$('#table-edit').on('click',function(){
					...
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '400px'],
					  content: '${hosts}/user/updatePage.do?jsp=/sys/user/user_edit&uid='+id //iframe的url
					});
