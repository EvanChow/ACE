			...
			jQuery(function($) {
					...
					aoColumns: [
					  { "title": '<label class="pos-rel"><input type="checkbox" class="ace" /><span class="lbl"></span></label>',
					    "mDataProp" : function(source,type,val){
							return '<label class="pos-rel"><input type="checkbox" class="ace" value="'+source.groupid+'" /><span class="lbl"></span></label>'},
					    "defaultContent": '',
					    "sType":"html",
					    "bSortable": false,
						"bVisible": true
				...
				$('#table-add').on('click',function(){
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '400px'],
					  content: '${hosts}/jump.do?jsp=/sys/group/group_add' //iframe的url
					}); 
				...
				$('#table-edit').on('click',function(){
					...
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '400px'],
					  content: '${hosts}/group/updatePage.do?jsp=/sys/group/group_edit&groupid='+id //iframe的url
					});
				...
				$('#table-delete').on('click',function(){
					...
					layer.confirm('是否要删除这'+count+'条数据？', {
					  btn: ['是','否'] //按钮
						...
						$.post("${hosts}/group/del.do",{groupid:ids},function(result){
					    if(result.success){
				...
				$('#table-search').on('click',function(){
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '400px'],
					  content: '${hosts}/jump.do?jsp=/sys/group/group_search' //iframe的url
					});
