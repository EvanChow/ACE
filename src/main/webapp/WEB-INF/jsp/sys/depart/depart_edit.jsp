	   ...
	   <div class="row">
		 <div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" id="form-add" action="${hosts}/menu/update.do" method="post">
	               <input type="hidden" id="form-field-icon-1" name="departid" value="${entity.departid}"/>
	           <div class="form-group" align="center">
					<div class="col-sm-12">
					    <label class="control-label no-padding-right">部门名称:</label>
						<span class="input-icon input-icon-right">
							<input type="text" id="form-field-icon-1" name="departname" value="${entity.departname}"/>
						</span>
						
						<label class="control-label no-padding-right">部门描述:</label>
						<span class="input-icon input-icon-right">
							<input type="text" id="form-field-icon-2" name="departdesc" value="${entity.departdesc}"/>
						</span>
					</div>
				</div>
