		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.DataTable( {
			        ...
			        sAjaxSource: "${hosts}/sysLog/dg.do",
				...
				$('#table-add').on('click',function(){
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '400px'],
					  content: '${hosts}/jump.do?jsp=/sys/log/SysLog_add' //iframe的url
					}); 
				...
				$('#table-edit').on('click',function(){
					...
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '400px'],
					  content: '${hosts}/sysLog/updatePage.do?jsp=/sys/log/SysLog_edit&id='+id //iframe的url
				...
				$('#table-delete').on('click',function(){
					...
					layer.confirm('是否要删除这'+count+'条数据？', {
					  btn: ['是','否'] //按钮
						...
						$.post("${hosts}/sysLog/del.do",{id:ids},function(result){
					    if(result.success){
				...
				$('#table-search').on('click',function(){
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '400px'],
					  content: '${hosts}/jump.do?jsp=/sys/SysLog/SysLog_search' //iframe的url
					});
