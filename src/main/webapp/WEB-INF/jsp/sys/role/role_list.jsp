			...
			jQuery(function($) {
					...
					aoColumns: [
					  { "title": '<label class="pos-rel"><input type="checkbox" class="ace" /><span class="lbl"></span></label>',
					    "mDataProp" : function(source,type,val){
							return '<label class="pos-rel"><input type="checkbox" class="ace" value="'+source.roleid+'" /><span class="lbl"></span></label>'},
					    "defaultContent": '',
					    "sType":"html",
					    "bSortable": false,
						"bVisible": true
				...
				$('#table-add').on('click',function(){
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '400px'],
					  content: '${hosts}/jump.do?jsp=/sys/role/role_add' //iframe的url
					}); 
				...
				$('#table-edit').on('click',function(){
					...
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '400px'],
					  content: '${hosts}/role/updatePage.do?jsp=/sys/role/role_edit&roleid='+id //iframe的url
					});
				...
				$('#table-delete').on('click',function(){
					...
					layer.confirm('是否要删除这'+count+'条数据？', {
					  btn: ['是','否'] //按钮
						...
						$.post("${hosts}/role/del.do",{roleid:ids},function(result){
					    if(result.success){
