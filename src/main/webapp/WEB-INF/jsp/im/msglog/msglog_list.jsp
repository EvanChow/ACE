			...
			jQuery(function($) {
				...
				.DataTable( {
					aoColumns: [
					  ...
					  { "title": "更新时间",
						"mDataProp":function(source,type,val){
							if(type === 'display'){
								return FormatDate('YYYY/MM/DD hh:mm:ss',source.updatetime);
							}
							return '--/--/--'},
						"defaultContent": "",
						"bSortable": false }
			        ...
			        sAjaxSource: "${hosts}/immsglog/dg.do",
				...
				$('#table-add').on('click',function(){
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '400px'],
					  content: '${hosts}/jump.do?jsp=/sys/immsglog/immsglog_add' //iframe的url
					}); 
				...
				$('#table-edit').on('click',function(){
					...
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '400px'],
					  content: '${hosts}/immsglog/updatePage.do?jsp=/sys/immsglog/immsglog_edit&id='+id //iframe的url
					});
				...
				$('#table-delete').on('click',function(){
					...
					layer.confirm('是否要删除这'+count+'条数据？', {
					  btn: ['是','否'] //按钮
						...
						$.post("${hosts}/immsglog/del.do",{id:ids},function(result){
					    if(result.success){
				...
				$('#table-search').on('click',function(){
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '400px'],
					  content: '${hosts}/jump.do?jsp=/sys/immsglog/immsglog_search' //iframe的url
					});
