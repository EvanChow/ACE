		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.DataTable( {
			        ...
			        sAjaxSource: "${hosts}/imgroups/dg.do",
				...
				$('#table-add').on('click',function(){
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '380px'],
					  content: '${hosts}/jump.do?jsp=/sys/imgroups/imgroups_add' //iframe的url
					}); 
				...
				$('#table-edit').on('click',function(){
					...
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '380px'],
					  content: '${hosts}/imgroups/updatePage.do?jsp=/sys/imgroups/imgroups_edit&id='+id //iframe的url
					});
				...
				$('#table-delete').on('click',function(){
					...
					layer.confirm('是否要删除这'+count+'条数据？', {
					  btn: ['是','否'] //按钮
						...
						$.post("${hosts}/imgroups/del.do",{id:ids},function(result){
					    if(result.success){
				...
				$('#table-search').on('click',function(){
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '400px'],
					  content: '${hosts}/jump.do?jsp=/sys/imgroups/imgroups_search' //iframe的url
					});
