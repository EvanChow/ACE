			...
			jQuery(function($) {
				...
				.DataTable( {
					aoColumns: [
					  ...
					  { "title": "头像",
						//"mDataProp" : "avatar",
						"mDataProp" : function(source,type,val){
							return '<div class="col-sm-3 col-md-3"><div class="thumbnail"><img alt="" src="'+source.avatar+'" ></div></div>';
						 },
						 "defaultContent": "",
						 "bSortable": false 
						 },
			        ...
			        sAjaxSource: "${hosts}/imuser/dg.do",
				...
				$('#table-add').on('click',function(){
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '400px'],
					  content: '${hosts}/jump.do?jsp=/im/user/imuser_add' //iframe的url
					}); 
				...
				$('#table-edit').on('click',function(){
					...
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '400px'],
					  content: '${hosts}/imuser/updatePage.do?jsp=/im/user/imuser_edit&id='+id //iframe的url
					});
				...
				$('#table-delete').on('click',function(){
					...
					layer.confirm('是否要删除这'+count+'条数据？', {
					  btn: ['是','否'] //按钮
						...
						$.post("${hosts}/imuser/del.do",{id:ids},function(result){
					    if(result.success){
				...
				$('#table-search').on('click',function(){
					layer.open({
					  ...
					  shade: 0,
					  area: ['600px', '400px'],
					  content: '${hosts}/jump.do?jsp=/sys/imuser/imuser_search' //iframe的url
					});
