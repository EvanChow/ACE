...
function(a) {
    ...
    f = {
        ...
        getDOMObjectPosition: function(a) {
            ...
            for ("" !== a.style.width && (b.width = a.style.width.replace("px", "")), "" !== a.style.height && (b.height = a.style.height.replace("px", "")); a;) b.left += a.offsetLeft,
            b.top += a.offsetTop,
            a = a.offsetParent;
            return b
        },
    ...
    f.Client.prototype = {
        ...
        destroy: function() {
            var b = this;
            this.domElement && this.div && (a(this.div).remove(), this.domElement = null, this.div = null, a.each(f.clients,
            function(a, c) {
        ...
        receiveEvent: function(a, d) {
            ...
            case "load":
                if (this.movie = c.getElementById(this.movieId), !this.movie) return e = this,
                void setTimeout(function() {
                    e.receiveEvent("load", null)
                },
                1);
                if (!this.ready && navigator.userAgent.match(/Firefox/) && navigator.userAgent.match(/Windows/)) return e = this,
                setTimeout(function() {
                    e.receiveEvent("load", null)
                },
                100),
            ...
            if (this.handlers[a]) for (var f = 0,
            g = this.handlers[a].length; g > f; f++) {
    ...
    k = function(a, b) {
        ...
        a.clearText();
        for (var d = 0,
        e = c.length; e > d; d++) a.appendText(c[d])
    },
    l = function(a) {
    ...
    return e.Buttons.swfPath = "ace/assets/swf/flashExport.swf",
    e.Api.register("buttons.resize()",
    function() {
        a.each(f.clients,
        function(a, b) {
    ...
    e.ext.buttons.copyFlash = a.extend({},
    n, {
        ...
        action: function(a, b, c, d) {
            if (d._fromFlash) {
                ...
                e.setAction("copy"),
                k(e, g),
                b.buttons.info(b.i18n("buttons.copyTitle", "复制到剪切板"), b.i18n("buttons.copyInfo", {
                    _: "复制%d行到剪切板",
                    1 : "复制1行到剪切板"
                },
                f.rows), 3e3)
    ...
    e.ext.buttons.csvFlash = a.extend({},
    n, {
    ...
    e.ext.buttons.excelFlash = a.extend({},
    n, {
        ...
        action: function(b, c, e, f) {
            ...
            for (var n = 0,
            o = l.body.length; o > n; n++) g += m(l.body[n]);
    ...
    e.ext.buttons.pdfFlash = a.extend({},
    n, {
