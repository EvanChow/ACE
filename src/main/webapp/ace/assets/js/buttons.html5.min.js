...
function(a) {
    ...
    f = function(a) {
        if ("undefined" == typeof navigator || !/MSIE [1-9]\./.test(navigator.userAgent)) {
            ...
            j = function(b) { (a.setImmediate || a.setTimeout)(function() {
                    throw b
                },
                0)
            },
            ...
            q = function(b, j) {
                ...
                j || (j = "download"),
                f ? (m = c().createObjectURL(b), e.href = m, e.download = j, g(e), s.readyState = s.DONE, v(), void n(m)) : (a.chrome && t && t !== k && (r = b.slice || b.webkitSlice, b = r.call(b, 0, b.size, k), u = !0), h && "download" !== j && (j += ".download"), (t === k || h) && (q = a), i ? (l += b.size, void i(a.TEMPORARY, l, x(function(a) {
    ...
    return e.ext.buttons.copyHtml5 = {
        ...
        action: function(b, d, e, f) {
            ...
            if (c.queryCommandSupported("copy")) {
                i.appendTo(d.table().container()),
                j[0].focus(),
                j[0].select();
                try {
                    return c.execCommand("copy"),
                    i.remove(),
                    void d.buttons.info(d.i18n("buttons.copyTitle", "复制到剪切板"), d.i18n("buttons.copySuccess", {
                        1 : "复制1行到剪切板",
                        _: "复制%d行到剪切板"
                    },
                    g.rows), 2e3)
            ...
            d.buttons.info(d.i18n("buttons.copyTitle", "Copy to clipboard"), m, 0),
            j[0].focus(),
            j[0].select();
            var n = a(m).closest(".dt-button-info"),
            o = function() {
                n.off("click.buttons-copy"),
                a(c).off(".buttons-copy"),
                d.buttons.info(!1)
            };
            n.on("click.buttons-copy", o),
            a(c).on("keydown.buttons-copy",
            function(a) {
                27 === a.keyCode && o()
    ...
    e.ext.buttons.csvHtml5 = {
        ...
        action: function(a, b, d, e) {
            var h = (j(e), k(b, e).str),
            i = e.charset;
            e.customize && (h = e.customize(h, e)),
            i !== !1 ? (i || (i = c.characterSet || c.charset), i && (i = ";charset=" + i)) : i = "",
            f(new Blob([h], {
                type: "text/csv" + i
            }), g(e))
        },
    ...
    e.ext.buttons.excelHtml5 = {
        ...
        action: function(c, e, i, j) {
            ...
            n = function(b) {
                for (var c = [], e = 0, f = b.length; f > e; e++) null !== b[e] && b[e] !== d || (b[e] = ""),
                c.push("number" == typeof b[e] || b[e].match && a.trim(b[e]).match(/^-?\d+(\.\d+)?$/) && "0" !== b[e].charAt(0) ? '<c t="n"><v>' + b[e] + "</v></c>": '<c t="inlineStr"><is><t>' + (b[e].replace ? b[e].replace(/&(?!amp;)/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "") : b[e]) + "</t></is></c>");
                return "<row>" + c.join("") + "</row>"
            };
            j.header && (k += n(l.header));
            for (var o = 0,
            p = l.body.length; p > o; o++) k += n(l.body[o]);
    ...
    e.ext.buttons.pdfHtml5 = {
        ...
        action: function(c, d, e, h) {
            ...
            m = [];
            h.header && m.push(a.map(k.header,
            function(a) {
                return {
            ...
            for (var n = 0,
            o = k.body.length; o > n; n++) m.push(a.map(k.body[n],
            function(a) {
                return {
                    text: "string" == typeof a ? a: a + "",
            ...
            h.footer && m.push(a.map(k.footer,
            function(a) {
                return {
                    text: "string" == typeof a ? a: a + "",
                    style: "tableFooter"
